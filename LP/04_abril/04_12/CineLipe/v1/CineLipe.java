...
public class CineLipe {
    public static void main(String args[]) {
        ...
        // Declarao de OBJs de String/StringBuilder (Para não ficar criando um novo a cada execução dos métodos)
        ...
        // Valor setado com 1 para iniciar o looping de uso da aplicaçao
        int n = 1;
    ...
    public static void escolherPoltronas(){
        System.out.println("Escolher pontrona");
    }
